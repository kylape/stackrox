...
// NewSearchCmd creates the search service command
func NewSearchCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "search",
		Short: "Search service operations",
		Long:  "Operations for the Search service.\n\nUse 'acs schema search' to see available methods.",
	}

	cmd.AddCommand(newSearchAutocompleteCmd())

	cmd.AddCommand(newSearchOptionsCmd())

	cmd.AddCommand(newSearchSearchCmd())

	return cmd
}

func newSearchAutocompleteCmd() *cobra.Command {
	var (
		flagQuery string
	...
	cmd := &cobra.Command{
		Use:   "autocomplete",
		Short: "Autocomplete",
		Long:  "HTTP: GET /v1/search/autocomplete",
...
func newSearchOptionsCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "options",
		Short: "Options",
		Long:  "HTTP: GET /v1/search/metadata/options",
		RunE: func(cmd *cobra.Command, args []string) error {
			// Build request
			cfg := client.Config{
				Endpoint: os.Getenv("ROX_ENDPOINT"),
...
func newSearchSearchCmd() *cobra.Command {
	var (
		flagQuery string
