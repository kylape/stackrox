...
import (
	...
	"github.com/stackrox/rox/results-controller/internal/controller"
	"github.com/stackrox/rox/results-controller/pkg/client"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		NewCache: func(config *rest.Config, opts cache.Options) (cache.Cache, error) {
			// Watch all namespaces since we need to create CRs in each namespace
	...
	if err = (&controller.StackRoxResultsReconciler{
		Client:        mgr.GetClient(),
		Scheme:        mgr.GetScheme(),
		CentralClient: centralClient,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "StackRoxResults")
		os.Exit(1)
	}
