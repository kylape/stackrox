...
func (m *Alert_ResourceReference) CloneVT() isAlert_Entity {
	if m == nil {
		return (*Alert_ResourceReference)(nil)
	}
	r := new(Alert_ResourceReference)
	r.ResourceReference = m.ResourceReference.CloneVT()
	return r
}
...
func (this *Alert_ResourceReference) EqualVT(thatIface isAlert_Entity) bool {
	that, ok := thatIface.(*Alert_ResourceReference)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.ResourceReference, that.ResourceReference; p != q {
		if p == nil {
			p = &ResourceReference{}
		}
		if q == nil {
...
func (m *Alert_ResourceReference) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Alert_ResourceReference) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ResourceReference != nil {
		size, err := m.ResourceReference.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Alert_ResourceReference) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Alert) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResourceReference", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Entity.(*Alert_ResourceReference); ok {
				if err := oneof.ResourceReference.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ResourceReference{}
				...
				m.Entity = &Alert_ResourceReference{ResourceReference: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *Alert) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			...
			if oneof, ok := m.Entity.(*Alert_ResourceReference); ok {
				if err := oneof.ResourceReference.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ResourceReference{}
...
func (m *ResourceReference) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
