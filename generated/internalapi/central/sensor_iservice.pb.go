...
type MsgFromSensor struct {
	...
	//	*MsgFromSensor_VulnerabilityQueryRequest
...
func (x *MsgFromSensor) GetVulnerabilityQueryRequest() *VulnerabilityQueryRequest {
	if x != nil {
		if x, ok := x.Msg.(*MsgFromSensor_VulnerabilityQueryRequest); ok {
			return x.VulnerabilityQueryRequest
		}
	}
	return nil
}
...
type MsgFromSensor_VulnerabilityQueryRequest struct {
	VulnerabilityQueryRequest *VulnerabilityQueryRequest `protobuf:"bytes,20,opt,name=vulnerability_query_request,json=vulnerabilityQueryRequest,proto3,oneof"`
}
...
func (*MsgFromSensor_VulnerabilityQueryRequest) isMsgFromSensor_Msg() {}
...
type MsgToSensor struct {
	...
	//	*MsgToSensor_VulnerabilityQueryResponse
...
func (x *MsgToSensor) GetVulnerabilityQueryResponse() *VulnerabilityQueryResponse {
	if x != nil {
		if x, ok := x.Msg.(*MsgToSensor_VulnerabilityQueryResponse); ok {
			return x.VulnerabilityQueryResponse
		}
	}
	return nil
}
...
type MsgToSensor_VulnerabilityQueryResponse struct {
	VulnerabilityQueryResponse *VulnerabilityQueryResponse `protobuf:"bytes,29,opt,name=vulnerability_query_response,json=vulnerabilityQueryResponse,proto3,oneof"`
}
...
func (*MsgToSensor_VulnerabilityQueryResponse) isMsgToSensor_Msg() {}
...
const file_internalapi_central_sensor_iservice_proto_rawDesc = "" +
	"\n" +
	")internalapi/central/sensor_iservice.proto\x12\acentral\x1a'internalapi/central/baseline_sync.proto\x1a(internalapi/central/cluster_config.proto\x1a)internalapi/central/cluster_metrics.proto\x1a(internalapi/central/cluster_status.proto\x1a-internalapi/central/compliance_operator.proto\x1a3internalapi/central/delegated_registry_config.proto\x1a0internalapi/central/deployment_enhancement.proto\x1a\x1finternalapi/central/hello.proto\x1a\x1finternalapi/central/image.proto\x1a'internalapi/central/local_scanner.proto\x1a/internalapi/central/network_baseline_sync.proto\x1a&internalapi/central/network_flow.proto\x1a%internalapi/central/policy_sync.proto\x1a;internalapi/central/process_listening_on_ports_update.proto\x1a6internalapi/central/secured_cluster_cert_refresh.proto\x1a'internalapi/central/sensor_events.proto\x1a(internalapi/central/sensor_upgrade.proto\x1a#internalapi/central/telemetry.proto\x1a-internalapi/central/vulnerability_query.proto\x1a\x15storage/cluster.proto\x1a\x13storage/image.proto\"\xc5\f\n" +
	...
	"#issue_secured_cluster_certs_request\x18\x13 \x01(\v2(.central.IssueSecuredClusterCertsRequestH\x00R\x1fissueSecuredClusterCertsRequest\x12d\n" +
	"\x1bvulnerability_query_request\x18\x14 \x01(\v2\".central.VulnerabilityQueryRequestH\x00R\x19vulnerabilityQueryRequestB\x05\n" +
	"\x03msg\"\x16\n" +
	"\x14ReprocessDeployments\"\x93\x12\n" +
	"\vMsgToSensor\x12>\n" +
	...
	"$issue_secured_cluster_certs_response\x18\x1c \x01(\v2).central.IssueSecuredClusterCertsResponseH\x00R issueSecuredClusterCertsResponse\x12g\n" +
	"\x1cvulnerability_query_response\x18\x1d \x01(\v2#.central.VulnerabilityQueryResponseH\x00R\x1avulnerabilityQueryResponseB\x05\n" +
	"\x03msg\"\xd5\x01\n" +
	"\fDeduperState\x12R\n" +
...
var file_internalapi_central_sensor_iservice_proto_goTypes = []any{
	...
	(*VulnerabilityQueryRequest)(nil),        // 30: central.VulnerabilityQueryRequest
	...
	(*VulnerabilityQueryResponse)(nil),       // 52: central.VulnerabilityQueryResponse
...
var file_internalapi_central_sensor_iservice_proto_depIdxs = []int32{
	...
	30, // 16: central.MsgFromSensor.vulnerability_query_request:type_name -> central.VulnerabilityQueryRequest
	...
	52, // 44: central.MsgToSensor.vulnerability_query_response:type_name -> central.VulnerabilityQueryResponse
	...
	1,  // 47: central.NodeInventoryACK.messageType:type_name -> central.NodeInventoryACK.MessageType
	12, // 48: central.AuditLogSync.node_audit_log_file_states:type_name -> central.AuditLogSync.NodeAuditLogFileStatesEntry
	13, // 49: central.AuditLogStatusInfo.node_audit_log_file_states:type_name -> central.AuditLogStatusInfo.NodeAuditLogFileStatesEntry
	14, // 50: central.InvalidateImageCache.image_keys:type_name -> central.InvalidateImageCache.ImageKey
	53, // 51: central.AuditLogSync.NodeAuditLogFileStatesEntry.value:type_name -> storage.AuditLogFileState
	53, // 52: central.AuditLogStatusInfo.NodeAuditLogFileStatesEntry.value:type_name -> storage.AuditLogFileState
	2,  // 53: central.SensorService.Communicate:input_type -> central.MsgFromSensor
	4,  // 54: central.SensorService.Communicate:output_type -> central.MsgToSensor
...
func file_internalapi_central_sensor_iservice_proto_init() {
	...
	file_internalapi_central_vulnerability_query_proto_init()
	file_internalapi_central_sensor_iservice_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*MsgFromSensor_VulnerabilityQueryRequest)(nil),
	}
	file_internalapi_central_sensor_iservice_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*MsgToSensor_VulnerabilityQueryResponse)(nil),
	}
	type x struct{}
