...
# Deploy StackRox with custom main image and nightly builds for other components
#
# Usage:
#   ./deploy-custom-main.sh [CUSTOM_MAIN_TAG] [NIGHTLY_TAG]
#
# Example:
#   ./deploy-custom-main.sh abc123 4.6.x-nightly-20241003
#
# Environment variables:
#   REGISTRY_USERNAME - Quay.io username (will prompt if not set)
#   REGISTRY_PASSWORD - Quay.io password (will prompt if not set)
#   PLATFORM - k8s or openshift (auto-detected if not set)
...
echo "========================================="
echo "Custom StackRox Deployment Configuration"
echo "========================================="
echo ""
...
export MAIN_IMAGE_REPO="localhost:5001/stackrox/main"
...
# roxctl - use nightly version to match other components
...
# Use Docker-based roxctl since local version won't match custom tag
...
# Additional deployment settings for local development
